...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/home.css" media="screen, projection" />
...
<body>
    ...
    <div id='nav'><ul>
        ...
        <?php else: ?>
        <li><?php echo CHtml::link('Packages',array('package/index')); ?></li>
